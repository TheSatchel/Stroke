...
export default class ConfigPanel {
  ...
  render() {
    ...
    const gearIcon = iconSvg(20, 20, [
      svgEl('path', { d: 'M10 1.5a1.5 1.5 0 0 0-1.2.7l-.6 1.4c-.1.2-.3.4-.5.5l-1.2.4c-.3.1-.6 0-.8-.2l-1.1-1.1a1.4 1.4 0 0 0-1.9 0L1.4 4.5c-.5.5-.5 1.3 0 1.9l1.1 1.1c.2.2.3.5.2.8l-.4 1.2c-.1.2-.3.4-.5.5l-1.4.6a1.4 1.4 0 0 0-.7 1.3v2.2c0 .5.3 1 .7 1.2l1.4.6c.2.1.4.3.5.5l.4 1.2c.1.3 0 .6-.2.8l-1.1 1.1c-.5.5-.5 1.3 0 1.9l1.3 1.3c.5.5 1.3.5 1.9 0l1.1-1.1c.2-.2.5-.3.8-.2l1.2.4c.2.1.4.3.5.5l.6 1.4a1.4 1.4 0 0 0 1.3.7h1.8c.6 0 1-.3 1.2-.7l.6-1.4c.1-.2.3-.4.5-.5l1.2-.4c.3-.1.6 0 .8.2l1.1 1.1c.5.5 1.3.5 1.9 0l1.3-1.3c.5-.5.5-1.3 0-1.9l-1.1-1.1c-.2-.2-.3-.5-.2-.8l.4-1.2c.1-.2.3-.4.5-.5l1.4-.6a1.4 1.4 0 0 0 .7-1.3V9c0-.5-.3-1-.7-1.2l-1.4-.6c-.2-.1-.4-.3-.5-.5l-.4-1.2c-.1-.3 0-.6.2-.8l1.1-1.1c.5-.5.5-1.3 0-1.9L16.7 1.4c-.5-.5-1.3-.5-1.9 0l-1.1 1.1c-.2.2-.5.3-.8.2l-1.2-.4c-.2-.1-.4-.3-.5-.5l-.6-1.4A1.4 1.4 0 0 0 9.5.2H7.7L7 1.5zM10 7a3 3 0 1 1 0 6 3 3 0 0 1 0-6z', fill: 'none', stroke: 'currentColor', 'stroke-width': '1.5', 'stroke-linejoin': 'round' })
    ]);
