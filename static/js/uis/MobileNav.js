...
const ICONS = {
  ...
  settings: [
    svgEl('circle', { cx: '7', cy: '6', r: '2.5', fill: 'currentColor' }),
    svgEl('path', { d: 'M7 9v13M7 3.5V0', stroke: 'currentColor', 'stroke-width': '2', 'stroke-linecap': 'round' }),
    svgEl('circle', { cx: '17', cy: '18', r: '2.5', fill: 'currentColor' }),
    svgEl('path', { d: 'M17 20.5v3M17 15V0', stroke: 'currentColor', 'stroke-width': '2', 'stroke-linecap': 'round' }),
  ],
};
